...
export const getUserFavoriteEventsController = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
        // Como la ruta estará protegida, sabemos que req.user existe.
        const { userId } = (req as any).user;

        const favoriteEvents = await UserService.findUserFavoriteEvents(userId);
